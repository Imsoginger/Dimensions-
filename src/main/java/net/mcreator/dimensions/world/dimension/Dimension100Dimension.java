...
package net.mcreator.dimensions.world.dimension;
...
import net.mcreator.dimensions.block.YellowWaterBlock;
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos, Blocks.OBSIDIAN.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return YellowWaterBlock.block.getDefaultState();
				}
			});
