...
public class PinkTree1Structure extends DimensionsElements.ModElement {
	public PinkTree1Structure(DimensionsElements instance) {
		super(instance, 21);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 500000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("dimensions", "pinktree1"));
						if (template == null)
							return false;
