...
package net.mcreator.dimensions.world.structure;
...
public class YellowTree1Structure extends DimensionsElements.ModElement {
	public YellowTree1Structure(DimensionsElements instance) {
		super(instance, 20);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 500000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("dimensions", "yellowtree1"));
						if (template == null)
							return false;
