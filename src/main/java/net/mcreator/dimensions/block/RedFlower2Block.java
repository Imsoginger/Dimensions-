...
public class RedFlower2Block extends DimensionsElements.ModElement {

	@ObjectHolder("dimensions:redflower2")
	public static final Block block = null;

	public RedFlower2Block(DimensionsElements instance) {
		super(instance, 29);
	}
