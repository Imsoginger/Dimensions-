...
import net.mcreator.dimensions.item.CucumberItem;
...
public class CucumberPlantBlock extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:cucumberplant")
	public static final Block block = null;
	public CucumberPlantBlock(DimensionsElements instance) {
		super(instance, 38);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CucumberItem.block, (int) (2)));
		}
