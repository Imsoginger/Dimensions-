...
public class OrangeFlower2Block extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:orangeflower2")
	public static final Block block = null;
	public OrangeFlower2Block(DimensionsElements instance) {
		super(instance, 27);
	}
