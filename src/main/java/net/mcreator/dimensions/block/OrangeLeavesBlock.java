...
public class OrangeLeavesBlock extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:orangeleaves")
	public static final Block block = null;
	public OrangeLeavesBlock(DimensionsElements instance) {
		super(instance, 11);
	}
