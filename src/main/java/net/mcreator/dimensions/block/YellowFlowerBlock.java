...
public class YellowFlowerBlock extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:yellowflower")
	public static final Block block = null;
	public YellowFlowerBlock(DimensionsElements instance) {
		super(instance, 30);
	}
