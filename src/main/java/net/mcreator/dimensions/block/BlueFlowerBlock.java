...
public class BlueFlowerBlock extends DimensionsElements.ModElement {

	@ObjectHolder("dimensions:blueflower")
	public static final Block block = null;

	public BlueFlowerBlock(DimensionsElements instance) {
		super(instance, 24);
	}
