...
public class OrangeFlowerBlock extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:orangeflower")
	public static final Block block = null;
	public OrangeFlowerBlock(DimensionsElements instance) {
		super(instance, 26);
	}
