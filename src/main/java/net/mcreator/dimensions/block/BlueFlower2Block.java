...
public class BlueFlower2Block extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:blueflower2")
	public static final Block block = null;
	public BlueFlower2Block(DimensionsElements instance) {
		super(instance, 25);
	}
