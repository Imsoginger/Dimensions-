...
public class RedLeavesBlock extends DimensionsElements.ModElement {
	@ObjectHolder("dimensions:redleaves")
	public static final Block block = null;
	public RedLeavesBlock(DimensionsElements instance) {
		super(instance, 10);
	}
